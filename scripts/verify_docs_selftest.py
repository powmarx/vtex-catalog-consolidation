...
MUTATIONS: list[tuple[str, object]] = [
    ...
    ("un-gitignore the reports directory", lambda r: patch(r, ".gitignore", "\nreports/*\n", "\nreport-output/*\n")),
    ("make the example report's exemption inert", lambda r: patch(r, ".gitignore", "\nreports/*\n", "\nreports/\n")),
    ("drop the example report's exemption", lambda r: patch(r, ".gitignore", "!reports/example-ProductEntry.md", "# no exemption")),
    ("let the example report's summary drift", lambda r: patch(r, "reports/example-ProductEntry.md", "| Links created | 257 |", "| Links created | 269 |")),
    ("truncate the example report's audit trail", lambda r: patch(r, "reports/example-ProductEntry.md", "| 76 | GardenStore | `e5e5e5e5-f6f6-4a7a-b8b8-c9c9c9c9c9c9` | 18 |\n", "")),
